            ...
            <div class="flex-1 h-full max-w-4xl mx-auto bg-white rounded-lg shadow-xl">
                <div class="flex flex-col md:flex-row">
                    ...
                    <div class="flex items-center justify-center p-6 sm:p-12 md:w-1/2">
                        <div class="w-full">
                            <h3 class="mb-4 text-xl font-bold text-black" style="color: #513444;">Make Reservation</h3>

                            <div class="w-full bg-gray-200 rounded-full">
                                <div
                                    class="w-40 p-1 text-xs font-bold leading-none text-center text-white bg-green-600 rounded-full"
                            ...
                            <form method="POST" action="{{ route('reservations.store.step.one') }}">
                                ...
                                <div class="mt-6 p-4 flex justify-end">
                                    <button type="submit"
                                        class="px-4 py-2 bg-green-500 rounded-lg text-white"
                                        style="background-color: #b5b09d;"
